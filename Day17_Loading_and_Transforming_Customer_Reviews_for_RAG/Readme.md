...
For today’s challenge, our goal is to **load customer reviews from Day 16**, process them, and create **searchable text chunks** for RAG applications.

We support **two processing strategies**:

* Keep each review intact as a **single chunk** (recommended for short reviews)
* Split longer reviews into **smaller overlapping chunks**

Once completed, we will have **properly sized text chunks stored in Snowflake**, ready for **embedding generation in Day 18**.

---

## Dataset

* **Source**: Customer reviews uploaded in **Day 16**
* **Table**: `EXTRACTED_DOCUMENTS`
* **Review Length**: ~50–150 words
* **Content**: Product feedback and customer sentiment
